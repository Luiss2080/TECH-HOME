...
/**
 * ============================================================================
 * TECH HOME BOLIVIA - Controlador del Dashboard Administrador
 * Gestión de la lógica de negocio y preparación de datos
 * ============================================================================
 */

require_once __DIR__ . '/../modelos/AdminModelo.php';
...
class AdminControlador {
    ...
    private function verificarAutenticacion() {
        if (!isset($_SESSION['usuario_id']) || empty($_SESSION['usuario_id'])) {
            $this->logDebug("Usuario no autenticado, redirigiendo a login");
    ...
    private function verificarPermisos() {
        ...
        $this->logDebug("Verificando rol del usuario: " . $rol);
